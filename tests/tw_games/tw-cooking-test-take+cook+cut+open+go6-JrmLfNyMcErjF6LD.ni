...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. A typical one.
 ...
 You can make out a fridge.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. You check the price tag glued to the fridge. Seventy big ones?! That's ridiculous! You know what, I've got a person, they work out of the bank, who could get you one of those for 35 bucks![end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " frosted-glass door leading east. There is an exit to the west. Don't worry, it is unguarded.".
...
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_3]But there isn't a thing on it. You swear loudly.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. A normal one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
 ...
 You hear a noise behind you and spin around, but you can't see anything other than a toilet. Now why would someone leave that there? [if there is something on the s_5]You see [a list of things on the s_5] on the toilet. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well, here we are in a bedroom. I guess you better just go and list everything you see here.

 Hey, want to see a bed? Look over there, a bed. [if there is something on the s_4]You see [a list of things on the s_4] on the bed.[end if]".
...
The slot_0 and the slot_1 and the slot_2 and the slot_3 and the slot_4 and the slot_5 and the slot_6 and the slot_7 and the slot_8 and the slot_9 are things.
The slot_0 and the slot_1 and the slot_2 and the slot_3 and the slot_4 and the slot_5 and the slot_6 and the slot_7 and the slot_8 and the slot_9 are privately-named.
The stove_0 are stove-likes.
The stove_0 are privately-named.

The description of d_0 is "it is what it is, a frosted-glass door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The s_2 is in r_1.
The description of s_3 is "The sofa is balanced.".
...
The s_4 is in r_4.
The description of s_5 is "The toilet is stable.".
...
The description of f_0 is "You couldn't pay me to eat that thing.".
...
The description of f_1 is "that's a yellow potato!".
