...
The kitchen part 1 is some text that varies. The kitchen part 1 is " fridge in the corner.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. Wow, isn't TextWorld just the best?[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " oven, which looks conventional, in the corner.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. Wow, isn't TextWorld just the best?[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You see a gleam over in a corner, where you can see a counter. Now why would someone leave that there? [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the stove_0] But there isn't a thing on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The slot_3 and the slot_4 and the slot_5 and the slot_6 and the slot_7 and the slot_8 and the slot_9 and the slot_0 and the slot_1 and the slot_2 are things.
The slot_3 and the slot_4 and the slot_5 and the slot_6 and the slot_7 and the slot_8 and the slot_9 and the slot_0 and the slot_1 and the slot_2 are privately-named.
...
The description of f_0 is "that's a yellow apple!".
...
The description of f_1 is "that's a yellow bell pepper!".
...
The f_1 is raw.
The f_1 is uncut.
The description of f_2 is "You couldn't pay me to eat that thing.".
